...
Some how this is not as easy as it seems - WebUI would connet to local Ollama (example worked 28/9-2024). Make shure to check settings - these will survive fron test to test in the Docker volumes.
```
