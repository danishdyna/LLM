...
* [UI - Open WebUI LLM (Large Language Models)](https://github.com/danishdyna/LLM/blob/main/Open-WebUI.md)
* [UI - Open WebUI LDM (Latent Diffusion Models)](https://github.com/danishdyna/LLM/blob/main/Diffusion-WebUI.md)
* [UI - VS Code (AI code helper IBM Granite LLM)](https://github.com/danishdyna/LLM/blob/main/VSCode-AI-Code-Helper.md)
